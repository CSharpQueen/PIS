...
namespace PPIS.Controllers
{
    public class ProblemController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Naziv,StatusGlavnogProblema")] Problem problem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Naziv,StatusGlavnogProblema")] Problem problem)
        {
            if (ModelState.IsValid)
            {
                ...
                foreach (var item in problem.Issue )
                {
                    ...
                    if (problem.StatusGlavnogProblema == StatusGlavnogProblema.UToku) item.StatusProblema = StatusProblema.UToku;
                }
